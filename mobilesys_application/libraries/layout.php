...
class Layout
{
	...
	*/
	public function __construct()
	{
		...
		$this->var["metadescr"]=array();
		$this->var["metakeyword"]=array();
	...
	*/
	...
	public function ajouter_metadescr($nom)
	{
		if($nom!="")
		{
		$this->var['metadescr'][] = metadescr_url($nom);
		return true;
		}
		return false;
	...
	public function ajouter_metakeyword($nom)
	{
		if($nom!="")
		{
		$this->var['metakeyword'][] = metakeyword_url($nom);
		return true;
		}
		return false;
	...
	public function ajouter_csshref($nom)
	{
	...
	public function ajouter_jshref($nom)
	{
	...
	*/
	...
	public function Entete($name, $data = array())
	{
		$this->var['header'] = $this->CI->load->view($name, $data, true);
		return $this;
	}

	public function Pied($name, $data = array())
	{
		$this->var['footer'] = $this->CI->load->view($name, $data, true);
		return $this;
	}
