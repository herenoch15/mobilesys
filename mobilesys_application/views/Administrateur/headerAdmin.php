...
<div id="headerAdmin" class="row" >
    <div class="col-md-12">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li <?php if($active=="Technologies") {?>  class="active" <?php } ?>><a href="<?php print site_url("Administrateur/technologies"); ?>">Technologies</a></li>
            <li <?php if($active=="Realisations") {?>  class="active" <?php } ?>><a href="<?php print site_url("Administrateur/realisations"); ?>">Réalisations</a></li>
