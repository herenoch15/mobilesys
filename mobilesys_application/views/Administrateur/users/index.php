        ...
        <div class="col-lg-12" >
            ...
            if(!empty($users))
            {
                ...
                foreach($users as $user)
                {
                    ...
                    if($current_user->id != $user->id) echo anchor('admin/users/edit/'.$user->id,'<span class="glyphicon glyphicon-pencil"></span>');
					if($current_u == $user->id) echo anchor('admin/users/delete/'.$user->id,'<span class="glyphicon glyphicon-remove"></span>');
                    else echo '&nbsp;';
                    echo '</td>';
                    echo '</tr>';
                }
