    ...
    <div id="servicesPage">
        ...
        <div class="row detailllepage listservice">
            ...
            <div class="col-md-8 col-sm-12">
                ...
                <div class="row panelImagesappServ">
                    <div class="col-sm-2 col-xs-2"><div class="panelcontour" ><img src="<?php print (site_url("assets/images/parallesdesktop.jpg")); ?>"></div></div>
                    <div class="col-sm-2 col-xs-2"><div class="panelcontour" ><img src="<?php print (site_url("assets/images/Linux.jpg")); ?>"></div></div>
                    <div class="col-sm-2 col-xs-2"><div class="panelcontour" ><img src="<?php print (site_url("assets/images/Linux.jpg")); ?>"></div></div>
                    <div class="col-sm-2 col-xs-2"><div class="panelcontour" ><img src="<?php print (site_url("assets/images/Linux.jpg")); ?>"></div></div>
                </div>
            </div>
